...
import { Plus, Search, Workflow, MoreHorizontal, Trash2, Copy, Sun, Moon, LogOut, User, Loader2, Settings, Mic, FileText } from 'lucide-react';
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end">
                ...
                <DropdownMenuItem onClick={() => navigate('/editor')}>
                  <FileText className="h-4 w-4 mr-2" /> Ideas & Scripts
                </DropdownMenuItem>
